<template>
	<aside>
		<a v-if="Online && Players" title="View List" aria-label="view list of online players" target="_blank" rel="noopener" href="https://server.devbox.themanaworld.org">Online: {{Players}} players</a>
		<a v-if="Online && !Players" title="View List" aria-label="view list of online players" target="_blank" rel="noopener" href="https://server.devbox.themanaworld.org">Online</a>
